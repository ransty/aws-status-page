...
echo "<h1>Todays NetworkPacketsIn Stats</h1>";
echo "Showing NetworkPacketsIn stats from <strong>" . date("F j, Y", strtotime("yesterday")) . " " . date("h:i:sa") . "</strong> to <strong>" . date("F d, Y h:i:sa") . "</strong><br>";
